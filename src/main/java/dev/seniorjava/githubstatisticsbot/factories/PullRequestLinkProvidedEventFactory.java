...
@Slf4j
@Component
public class PullRequestLinkProvidedEventFactory implements EventFactory {

  @Override
  public Event create(final Update update) {
    final Message message = update.message();
    return new PullRequestLinkProvidedEvent(message.chat().id(), message.text());
  }
  ...
  public boolean canCreateEvent(final Update update) {
    ...
    final String expectedMessageStart = "Please, provide a link to a PR strictly in the following format";
